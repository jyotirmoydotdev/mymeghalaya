      ...
      <div className="p-5">
        ...
        <div className="flex justify-center pb-5 sm:p-5"> 
          <div className="max-w-5xl grid grid-cols-1 sm:grid-cols-2 w-full gap-10 items-center">
            ...
            <DirectionAwareHover name='' imageUrl={supabaseUrl("/images-public/wei-sawdong.webp")} className=' h-[516px] rounded-lg order-1 sm:order-2'>
          ...
          <Tabs defaultValue="geography" className=" w-full max-w-5xl">
            ...
            <TabsContent value="geography">
              <div className="grid grid-cols-1 sm:grid-cols-2 w-full gap-5 py-3">
                ...
                <DirectionAwareHover name='' imageUrl={supabaseUrl("/images-public/daribokgre.webp")} className='h-full border  rounded-lg  order-1'>
                ...
                <DirectionAwareHover name='' imageUrl={supabaseUrl("/images-public/nohkalikai-falls.webp")} className='h-full border rounded-lg  order-3 sm:order-4'>
                ...
                <DirectionAwareHover name='' imageUrl={supabaseUrl("/images-public/cherrapunji.webp")} className='h-full  border rounded-lg order-5'>
                  <div className="flex flex-col gap-1">
                ...
                <DirectionAwareHover name='' imageUrl={supabaseUrl("/images-public/red-panda.webp")} className='h-full  border rounded-lg order-7 sm:order-8'>
                  <div className="flex flex-col gap-1">
            ...
            <TabsContent value="history">
              <div className="grid grid-cols-1 sm:grid-cols-2 w-full gap-5 py-3">
                ...
                <DirectionAwareHover name='' imageUrl={supabaseUrl("/images-public/neolithic.webp")} className='h-full border rounded-lg  order-1'>
                ...
                <DirectionAwareHover name='' imageUrl={supabaseUrl("/images-public/kamarupa.webp")} className='h-full border rounded-lg  order-3 sm:order-4'>
                  <p className="font-bold text-xl">Kamarupa Kingdom</p>
                  <p className="font-normal text-sm">Kamarupa from 350 to 1140 CE</p>
                </DirectionAwareHover>

                <DirectionAwareHover name='' imageUrl={supabaseUrl("/images-public/shillong-before-1897.webp")} className='h-full  border rounded-lg order-5'>
            ...
            <TabsContent value="culture">
              <div className="grid grid-cols-1 sm:grid-cols-2 w-full gap-5 py-3">
                ...
                <DirectionAwareHover name='' imageUrl={supabaseUrl("/images-public/culture1.webp")} className='h-full border rounded-lg  order-1'>
                ...
                <DirectionAwareHover name='' imageUrl={supabaseUrl("/images-public/student-unions.webp")} className='h-full border rounded-lg  order-3 sm:order-4'>
            ...
            <TabsContent value="transport">
              <div className="grid grid-cols-1 sm:grid-cols-2 w-full gap-5 py-3">
                ...
                <DirectionAwareHover name='' imageUrl={supabaseUrl("/images-public/meghalaya-road-map.webp")} className='h-full border rounded-lg  order-1'>
                ...
                <DirectionAwareHover name='' imageUrl={supabaseUrl("/images-public/shillong-airport.webp")} className='h-full border rounded-lg  order-3 sm:order-4'>
