...
const page = () => {
    ...
    const images = [
        {
            ...
            imgUrl: supabaseFetch("/images-public/dawki.webp"),
        ...
        },
        {
            ...
            imgUrl: supabaseFetch("/images-public/cherrapunji.webp"),
        ...
        },
        {
            ...
            imgUrl: supabaseFetch("/images-public/wei-sawdong.webp"),
        ...
        },
        {
            ...
            location: "Cherrapunji, East Khasi Hills",
            imgUrl: supabaseFetch("/images-public/nohkalikai-falls.webp"),
    ...
    return (
        <div className=" container px-5 min-h-[90vh]">
            ...
            <div className="flex flex-col justify-start items-center py-12 h-full">
