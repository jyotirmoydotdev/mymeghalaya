...
const page: React.FC = () => {
  return (
    <div className="p-8 max-w-3xl mx-auto">
      <h1 className="text-xl sm:text-3xl font-semibold mb-6">Contact Support</h1>
      ...
      <ul className="list-disc list-inside space-y-2 mb-6 text-xs sm:text-base">
        <li>
      ...
      <div className="flex gap-1">
        <p className="text-xs sm:text-lg">Contact us via email at:</p>
        <a href="mailto:care.jyotirmoy@gmail.com" className="text-blue-600 underline text-xs sm:text-lg">
