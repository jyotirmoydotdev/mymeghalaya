...
import { handleGoogleSignin, signUpAction } from "@/functions/auth";
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 items-center">
        ...
        <div className="flex flex-col justify-center items-center place-self-center py-4 sm:py-12 h-full max-w-[425px]">
          ...
          <div className="pb-4 sm:pb-6 text-center w-full">
            <div className="text-lg sm:text-3xl sm:pb-2 font-bold">Sign up for new account</div>
            <p className="text-sm text-muted-foreground">
               Already have an account?{" "}
               <Link href={'/login'} className="px-1 font-medium underline text-black">Log in</Link>
             </p>
          </div>
            ...
            <div className="grid gap-2">
              <div className="grid gap-4">
                <div className="flex flex-col gap-2">
                  ...
                  <Input className="text-[16.1px]" type="text" name="text" placeholder="your name" required />
                </div>
                <div className="flex flex-col gap-2">
