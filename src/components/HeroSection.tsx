...
const HeroSection = () => {
  return (
    <div className="flex flex-col justify-center py-10  bg-sky-50">
        <div className="text-5xl sm:text-8xl text-left sm:text-center uppercase font-black sm:font-semibold bg-clip-text text-transparent bg-gradient-to-t from-sky-50 to-gray-500 px-5 " >
            Abode of the clouds
        </div>
        <div className="flex justify-center py-5">        
            <div className="grid grid-cols-1 sm:grid-cols-2 text-left gap-5 max-w-5xl px-5 sm:px-0 ">
                <div className=" bg-gray-100 rounded-md">
                    {/* <Image src={"/KynremFalls.webp"}  className=' rounded-md w-full object-cover' width={500} height={500} alt=''></Image> */}
                ...
                <div className="flex flex-col justify-around">
                    ...
                    <div className="flex flex-col sm:flex-row gap-2">
                        ...
                        <Link href={'/'}>
                            <Cover>
                                <div className="py-10 sm:py-0 text-blue-600 text-xl sm:text-3xl flex gap-5 items-end italic hover:translate-x-2 animate transition duration-300" >
