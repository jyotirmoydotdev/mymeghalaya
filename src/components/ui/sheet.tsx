...
interface SheetContentProps
  ...
  <SheetPortal>
    ...
    >
     {
      (side === "top"?(<></>):( 
      <SheetPrimitive.Close className="absolute right-4 top-7 outline-none rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none disabled:pointer-events-none data-[state=open]:bg-secondary">
