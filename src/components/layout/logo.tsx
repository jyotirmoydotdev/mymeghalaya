    ...
    <>
      ...
      <div className="hidden sm:block">
        <Link href={"/"} className="flex">
          ...
          />
          <div className="flex items-baseline text-gray-700 pl-2 font-black " >
            <div className="text-3xl">M</div>
            <div className="text-2xl">Y</div>
            <div className="text-3xl">M</div>
            <div className="text-2xl">EGHALAYA</div>
      ...
      <div className="block sm:hidden">
        <div className="flex items-center">
          ...
          />
          <div className="flex items-baseline text-gray-700 font-black  pl-1" >
            <div className="">M</div>
