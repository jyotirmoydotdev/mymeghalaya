...
const HeroSection = () => {
    ...
    return (
        <div className=" container max-w-7xl px-4 pt-4 pb-4 sm:pb-16 ">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-5 sm:px-10 ">
                <DirectionAwareHover isPriority={false} name={data.title} imgBlurDataUrl={data.images.img1.imageBlurDataUrl} imageUrl={data.images.img1.imgUrl} className='h-full object-cover rounded-xl sm:rounded-3xl shadow-2xl'>
                    <div className="">
                ...
                <div className="grid grid-rows-4 grid-cols-1 ">
                    ...
                    <div className="row-span-2 grid grid-cols-2 gap-3 sm:gap-5 order-1 sm:order-2">
                        <DirectionAwareHover isPriority={false} name={data.title} imgBlurDataUrl={data.images.img2.imageBlurDataUrl} imageUrl={data.images.img2.imgUrl} className='h-full w-full object-cover rounded-xl sm:rounded-3xl shadow-md'>
                        ...
                        <DirectionAwareHover isPriority={false} name={data.title} imgBlurDataUrl={data.images.img3.imageBlurDataUrl} imageUrl={data.images.img3.imgUrl} className='h-full w-full object-cover rounded-xl sm:rounded-3xl shadow-md'>
