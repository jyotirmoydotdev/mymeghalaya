        ...
        <div className=" container max-w-7xl px-0  py-5 ">
            ...
            <div className="flex justify-center py-5">
                <div className="grid grid-cols-1 sm:grid-cols-2 text-left gap-5 max-w-5xl px-4 sm:px-0">
                    <div className="">
                        <DirectionAwareHover name={data.title} imgBlurDataUrl={data.images.img1.imageBlurDataUrl} imageUrl={data.images.img1.imgUrl} className=' w-full object-cover h-full rounded-lg'>
                            <div className="">
                    ...
                    <div className="flex flex-col justify-around">
                        ...
                        <div className="flex gap-3 sm:gap-5 justify-center sm:justify-start">
                            <DirectionAwareHover name={data.title} imgBlurDataUrl={data.images.img2.imageBlurDataUrl} imageUrl={data.images.img2.imgUrl} className='size-44 sm:size-60 object-cover rounded-lg'>
                            ...
                            <DirectionAwareHover name={data.title} imgBlurDataUrl={data.images.img3.imageBlurDataUrl} imageUrl={data.images.img3.imgUrl} className='size-44 sm:size-60 object-cover rounded-lg'>
